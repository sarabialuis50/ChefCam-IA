...
const LandingView: React.FC<LandingViewProps> = ({ onStart }) => {
  return (
    <div className="bg-[#0A0A0A] font-body antialiased min-h-screen text-white overflow-x-hidden selection:bg-primary selection:text-black">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 w-full z-50 px-6 py-4 sm:py-6 bg-[#0A0A0A]/80 backdrop-blur-md border-b border-white/5">
      ...
      <main className="relative pt-24 pb-20">
        {/* Background Image / Overlay - Art Direction for Mobile & PC */}
        <div className="fixed inset-0 z-0 text-left">
          {/* Versión PC (Escritorio) - Visible en lg y superiores */}
          ...
          {/* Versión Móvil/Tablet - Visible en pantallas menores a lg */}
